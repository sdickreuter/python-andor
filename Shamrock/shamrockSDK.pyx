...
def GetNumberGratings():
    ...
    verbose(error, "GetNumberGratings")
    return n
...
def GetWavelengthLimits(grating):
    ...
    verbose(error, "GetWavelengthLimits")
    return min, max
...
def SetFlipperMirrorPosition(flipper, position):
    ...
    verbose(error, "SetFlipperMirrorPosition")
...
def GetFlipperMirrorPosition(flipper):
    ...
    verbose(error, "GetFlipperMirrorPosition")
    return pos
...
def SetAutoSlitWidth(index, width): # width in um !
    ...
    verbose(error, "SetAutoSlitWidth")
...
def GetAutoSlitWidth(index):
    ...
    verbose(error, "GetAutoSlitWidth")
    return w # w in um !
